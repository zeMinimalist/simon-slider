...
$(function () {
  ...
  var $slider = $('#simon_slider');
  var $first = $slider.find('.slider__track li:first', 'ul');
  var $last = $slider.find('.slider__track li:last', 'ul'); // Initialize opening state
  ...
  var $nav = $slider.find('.slider__nav'); // populate nav
...
__webpack_require__(/*! /Users/zeminimalist/Documents/Sites/simon-slider/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/zeminimalist/Documents/Sites/simon-slider/resources/css/app.scss */"./resources/css/app.scss");
